...
SRC_FILES = src/Vector/mathf.c src/math/math.f.c src/Parse/boolf/.utilsf.c src/Parse/FileParsing/utils.c \
			...
			src/Intersection/plane.c src/Intersection/sphere.c 
