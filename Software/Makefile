...
SRC_FILES = src/Parse/FileParsing/init.c src/Parse/FileParsing/utils.f.c src/Parse/FileParsing/utils.c src/Parse/Functions/Model.u.c \
	src/Parse/Functions/Vector.c src/Parse/Functions/intersections/models.i.c src/Parse/Functions/model.initialize.c src/Parse/Functions/Model.c \
	src/Parse/Memory/List.c src/Parse/Memory/delete.c src/Parse/boolf/.utilsf.c src/Parse/errorf/errorf.c \
	src/math/math.f.c src/mlx/mlx.u.c src/mlx/HookSystem.c src/main.c
